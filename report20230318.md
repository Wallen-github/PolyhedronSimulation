...
1. The shape of the concave polyhedron is revised.
2. The positions of two polyhedrons are changed too.
3. Line 668, rigidContactor3D: The calculation method assumes that the body is convex!!
...
The raw data and configuration which I want to create are shown below.
...
But, the results got from the LMGC90 code are
...
Comparing these results and raw data, we can find two considerable differences. **1. The shape of the concave polyhedron is revised. 2. The positions of two polyhedrons are changed too**. 
...
The largest problem is **Line 668, rigidContactor3D: The calculation method assumes that the body is convex!!**
